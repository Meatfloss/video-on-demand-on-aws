...
./build-s3-dist.sh vod-template video-on-demand-on-aws v1.6
```
...
aws s3 cp ./regional-s3-assets/ s3://vod-template-us-east-1/video-on-demand-on-aws/v1.6/ --recursive --acl bucket-owner-full-control
```
